...
class NIDMTabContent(QWidget):
    """
        This is the Inverse Normal Distribution Method tab content class.
    ...
    def __init__(self):
        """
            This is the constructor method for the NIDMTabContent class.
            It initializes the tab and its components.
        """
        super().__init__()

        # Initialize and position the amount of xi numbers label and spinbox
